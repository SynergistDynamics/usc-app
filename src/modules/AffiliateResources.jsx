        ...
        <div>
          <div style={{ marginBottom:40 }}>
            ...
            <div style={{ background:'#EFF6EE', border:`1px solid ${C.sage}`, borderRadius:6, padding:'14px 20px', display:'flex', alignItems:'center', gap:14 }}>
              ...
              <a href="https://urban-sheds-builder-affiliate-program.netlify.app/" target="_blank" rel="noreferrer" style={{ flexShrink:0, fontFamily:'DM Sans', fontSize:12, fontWeight:600, color:C.sage, textDecoration:'none', whiteSpace:'nowrap' }}>Full program details ↗</a>
            </div>
          </div>
        ...
        <div>
          <div style={{ marginBottom:40 }}>
            ...
            <div style={{ display:'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap:16 }}>
              {[{id:'assessment',category:'STEP 1 — QUALIFY THEM',title:'Builder Self-Assessment',description:"19 questions across 5 categories. Takes 3 minutes. Tells a potential builder honestly whether they're the right fit.",url:'https://urban-sheds-builder-assessment.netlify.app/',cta:'Open Assessment',icon:'📋',color:C.sage},{id:'licensing',category:'STEP 2 — CLOSE THEM',title:'Licensing Program Overview',description:"The full pitch — territory, what's included, pricing, and what sets USC apart. Send this once they've passed the assessment.",url:'https://urban-sheds-builder-licensing-program.netlify.app/',cta:'Open Program Overview',icon:'📄',color:'#1A1A1A'}].map(r=>(
